...
export const RocketIcon: React.FC<IconProps> = ({ className = "", size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2.5L13.09 8.26L22 12L13.09 15.74L12 21.5L10.91 15.74L2 12L10.91 8.26L12 2.5Z" fill="currentColor"/>
  </svg>
);
...
export const TargetIcon: React.FC<IconProps> = ({ className = "", size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2C13.1 2 14 2.9 14 4C14 5.1 13.1 6 12 6C10.9 6 10 5.1 10 4C10 2.9 10.9 2 12 2ZM21 9V7L15 1H5C3.89 1 3 1.89 3 3V21C3 22.11 3.89 23 5 23H19C20.11 23 21 22.11 21 21V19L23 17V15L21 13V11L23 9H21ZM19 19H5V3H13V9H19V19Z" fill="currentColor"/>
  </svg>
);
...
export const MoneyIcon: React.FC<IconProps> = ({ className = "", size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2C6.48 2 2 6.48 2 12S6.48 22 12 22 22 17.52 22 12 17.52 2 12 2ZM13 17H11V15H9V13H11V11H9V9H11V7H13V9H15V11H13V13H15V15H13V17Z" fill="currentColor"/>
  </svg>
);
...
export const SatelliteIcon: React.FC<IconProps> = ({ className = "", size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M12 8L14 12L18 14L14 16L12 20L10 16L6 14L10 12L12 8Z" fill="currentColor"/>
  </svg>
);

export const TornadoIcon: React.FC<IconProps> = ({ className = "", size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2C6.48 2 2 6.48 2 12S6.48 22 12 22 22 17.52 22 12 17.52 2 12 2ZM12 20C7.59 20 4 16.41 4 12S7.59 4 12 4 20 7.59 20 12 16.41 20 12 20ZM12 6C8.69 6 6 8.69 6 12S8.69 18 12 18 18 15.31 18 12 15.31 6 12 6ZM12 16C9.79 16 8 14.21 8 12S9.79 8 12 8 16 9.79 16 12 14.21 16 12 16Z" fill="currentColor"/>
    <path d="M8 8C8 8 10 10 12 10C14 10 16 8 16 8L14 12C14 12 12 14 10 14C8 14 6 12 6 12L8 8Z" fill="currentColor"/>
  </svg>
);
...
export const OilIcon: React.FC<IconProps> = ({ className = "", size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2C6.48 2 2 6.48 2 12S6.48 22 12 22 22 17.52 22 12 17.52 2 12 2ZM12 20C7.59 20 4 16.41 4 12S7.59 4 12 4 20 7.59 20 12 16.41 20 12 20ZM12 6C8.69 6 6 8.69 6 12S8.69 18 12 18 18 15.31 18 12 15.31 6 12 6ZM12 16C9.79 16 8 14.21 8 12S9.79 8 12 8 16 9.79 16 12 14.21 16 12 16Z" fill="currentColor"/>
    <path d="M8 8H16V16H8V8ZM10 10V14H14V10H10Z" fill="currentColor"/>
  </svg>
);

export const ConstructionIcon: React.FC<IconProps> = ({ className = "", size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M22.7 19L13.6 9.9L15.4 8.1L22.7 15.4C23.1 15.8 23.1 16.6 22.7 19ZM13.1 9.2L12 8.1L2.3 17.8C1.9 18.2 1.9 19 2.3 19.4L4.1 21.2L13.1 9.2Z" fill="currentColor"/>
  </svg>
);
...
export const NumberIcon: React.FC<IconProps & { number: number }> = ({ className = "", size = 24, number }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="12" cy="12" r="10" fill="currentColor"/>
    <text x="12" y="16" textAnchor="middle" fill="white" fontSize="12" fontWeight="bold">{number}</text>
  </svg>
);
